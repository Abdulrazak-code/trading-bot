...
- OVEREXTENSION VETO: If bb_position > 1.0 OR RSI > 78, do NOT BUY — bb_position > 1.0 means price is literally above the upper Bollinger Band, which is the hard veto. bb_position of 0.90-1.0 is near the top of the band but still allowed. These are hard veto conditions, not entry signals.
